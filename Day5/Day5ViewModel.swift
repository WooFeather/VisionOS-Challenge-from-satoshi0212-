...
@MainActor class Day5ViewModel: ObservableObject {
    ...
    func addCube() {
        ...
        entity.components.set(ModelComponent(mesh: .generateBox(width: 0.5, height: 0.5, depth: 0.5), materials: [material1, material2, material3, material4, material5, material6])
        )
